...
public class Entity {
    ...
    private List<Field> getFieldsIncludingJoins(boolean isForeign, String path, boolean forceNullable) throws GeneratorException {
    ...
    public void addSortOrder(Field field, String ascDesc) {
        boolean descending = DEFAULT_ORDER_DESC.equalsIgnoreCase(ascDesc);
